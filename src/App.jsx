...
export default function App() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      ...
      previous = now;
      setProgress((p) => advanceProgress(p, delta, speed, multiplier));
    }, 40);
    ...
    <div className="app-shell">
      ...
      <main className="studio">
        <div className="workspace">
          <PrinterView
            {...{ model, layers, color, progress, running, view, setView }}
          />
          <div className="transport">
            ...
            <span className="layer-count">
              Layer <b>{Math.min(layers, Math.ceil(progress * layers))}</b>
              <span> / </span>
              {layers}
            </span>
      ...
      >
        ...
        <ol>
          <li>
            ...
            <span>
              Pick a spiral vase, cube, or twisted vessel. Changing the model or
              layer height resets the build.
            </span>
          </li>
          <li>
            <b>Make it yours</b>
            <span>
              Choose a filament color and layer height. All models use a
              continuous, hollow perimeter; finer layers reveal more detail.
            </span>
          </li>
          <li>
        ...
        <div className="help-note">
          ...
          Motion is time-compressed: about 4 minutes at 1× and 60 mm/s.
          Temperature values are simulated targets.
        </div>
